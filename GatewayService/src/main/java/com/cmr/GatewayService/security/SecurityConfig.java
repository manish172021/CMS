package com.cmr.GatewayService.security;

import com.cmr.GatewayService.model.Role;
import com.cmr.GatewayService.security.jwt.JwtAuthorizationFilter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers("/cms/authentication/**").permitAll()//login and register pre-path
